...
class Hacker(User):
    ...
    groups: Mapped[List["HackerGroup"]] = relationship('HackerGroup', secondary='hacker_group_user')
    # is_leader: bool = mapped_column(Integer, default=0)
    events: Mapped[List["Event"]] = relationship('Event', secondary='hacker_event_participation')

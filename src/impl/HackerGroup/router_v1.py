...
def add_hacker(groupId: int,
    ...
    return {"success": True, "added_hacker_id":hackerId, "added_group_id": hacker_group.id}
...
def add_hacker_by_code(group_code: str,
    ...
    return {"success": True, "added_hacker_id":hacker_id, "added_group_id": hacker_group.id}
...
def remove_hacker(groupId: int,
                  hackerId: int,
                  data: BaseToken = Depends(JWTBearer())):
    hackergroup_service.remove_hacker_from_group(
        groupId, hackerId, data)

...
class HackerGroupUser(BaseModel):
    ...
    hacker_id: Mapped[int] = mapped_column(Integer, ForeignKey('hacker.user_id'), primary_key=True)
    group_id: Mapped[int] = mapped_column(Integer, ForeignKey('hacker_group.id'), primary_key=True)

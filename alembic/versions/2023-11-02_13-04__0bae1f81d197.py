...
def upgrade():
    ...
    op.create_index(op.f("ix_mail_queue_body"), "mail_queue", ["body"], unique=False)
    op.create_index(op.f("ix_mail_queue_id"), "mail_queue", ["id"], unique=False)
    op.create_index(
        op.f("ix_mail_queue_subject"), "mail_queue", ["subject"], unique=False
    )
    op.alter_column("user", "recive_mails", existing_type=sa.BOOLEAN(), nullable=True)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column("user", "recive_mails", existing_type=sa.BOOLEAN(), nullable=False)

...
def downgrade():
    ...
    op.add_column(
        'my_user',
        sa.Column(
            'lleidacoins_claimed', sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        'my_user',
        sa.Column('recive_mails', sa.BOOLEAN(), autoincrement=False, nullable=True),
    )
    op.add_column(
        'lleida_hacker',
        sa.Column('rejected', sa.INTEGER(), autoincrement=False, nullable=True),
    )
    op.add_column(
        'event', sa.Column('status', sa.INTEGER(), autoincrement=False, nullable=True)
    )

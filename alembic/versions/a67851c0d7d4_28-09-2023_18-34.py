...
def upgrade():
    ...
    op.add_column('hacker_event_registration', sa.Column('confirm_assistance_token', sa.String(), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('hacker_event_registration', sa.Column('confirmed_assistance_token', sa.VARCHAR(), autoincrement=False, nullable=True))

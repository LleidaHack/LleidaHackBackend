...
def upgrade():
    ...
    op.create_index(
        op.f('ix_company_event_participation_company_id'),
        'company_event_participation',
        ['company_id'],
        unique=False,
    )
    op.create_index(
        op.f('ix_company_event_participation_event_id'),
        'company_event_participation',
        ['event_id'],
        unique=False,
    )
    ...
    op.create_index(
        op.f('ix_hacker_event_accepted_event_id'),
        'hacker_event_accepted',
        ['event_id'],
        unique=False,
    )
    op.create_index(
        op.f('ix_hacker_event_accepted_user_id'),
        'hacker_event_accepted',
        ['user_id'],
        unique=False,
    )
    ...
    op.create_index(
        op.f('ix_hacker_event_participation_event_id'),
        'hacker_event_participation',
        ['event_id'],
        unique=False,
    )
    op.create_index(
        op.f('ix_hacker_event_participation_user_id'),
        'hacker_event_participation',
        ['user_id'],
        unique=False,
    )
    ...
    op.create_index(
        op.f('ix_hacker_event_registration_event_id'),
        'hacker_event_registration',
        ['event_id'],
        unique=False,
    )
    op.create_index(
        op.f('ix_hacker_event_registration_user_id'),
        'hacker_event_registration',
        ['user_id'],
        unique=False,
    )
    ...
    op.create_index(
        op.f('ix_hacker_rejected_notification_id'),
        'hacker_rejected_notification',
        ['id'],
        unique=False,
    )
    op.create_table(
        'lleida_hacker_accepted_notification',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ['id'],
            ['notification.id'],
    ...
    op.create_index(
        op.f('ix_lleida_hacker_accepted_notification_id'),
        'lleida_hacker_accepted_notification',
        ['id'],
        unique=False,
    )
    ...
    op.create_index(
        op.f('ix_lleida_hacker_event_participation_event_id'),
        'lleida_hacker_event_participation',
        ['event_id'],
        unique=False,
    )
    ...
    op.create_index(
        op.f('ix_lleida_hacker_rejected_notification_id'),
        'lleida_hacker_rejected_notification',
        ['id'],
        unique=False,
    )

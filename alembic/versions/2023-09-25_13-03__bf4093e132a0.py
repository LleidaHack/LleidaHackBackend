...
def upgrade():
    ...
    op.add_column(
        "hacker", sa.Column("how_did_you_meet_us", sa.String(), nullable=True)
    )
    op.add_column(
        "hacker_event_registration", sa.Column("studies", sa.String(), nullable=True)
    )
    op.add_column(
    ...
    op.add_column(
        "hacker_event_registration", sa.Column("location", sa.String(), nullable=True)
    )
    op.add_column(
        "hacker_event_registration",

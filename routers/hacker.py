...
@router.put("/group/{groupId}", tags=["Hacker"])
...
@router.delete("/group/{groupId}", tags=["Hacker"])
...
@router.get("/group/{groupId}/members", tags=["Hacker"])
...
@router.post("/group/{groupId}/add/{hackerId}", tags=["Hacker","HackerGroup"])

...
async def add_lleidahacker_group_member(groupId: int,
                                        lleidahackerId: int,
                                        response: Response,
                                        db: Session = Depends(get_db),
                                        str=Depends(oauth_schema)):
...
async def delete_lleidahacker_group_member(groupId: int,
                                           lleidahackerId: int,
                                           response: Response,
                                           db: Session = Depends(get_db),
                                           str=Depends(oauth_schema)):
...
async def set_lleidahacker_group_leader(groupId: int,
                                        lleidahackerId: int,
                                        response: Response,
                                        db: Session = Depends(get_db),
                                        str=Depends(oauth_schema)):

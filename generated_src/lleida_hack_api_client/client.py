...
class Client:
    ...
    _verify_ssl: Union[str, bool, ssl.SSLContext] = field(default=True,
                                                          kw_only=True)
    ...
    _async_client: Optional[httpx.AsyncClient] = field(default=None,
                                                       init=False)
    ...
    def set_async_httpx_client(self,
                               async_client: httpx.AsyncClient) -> "Client":
